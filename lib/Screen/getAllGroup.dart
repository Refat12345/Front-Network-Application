...
//                   child: ListView.builder(
//                     itemCount:
//                     getAllGroupmodel?.userGroupsDTOResponses?.length,
//                     itemBuilder: (context, index) {
//                       return Card(
//                         elevation: 2,
//                         child: ListTile(
//                           leading: Icon(Icons.group),
//                           title: Text(
//                             getAllGroupmodel?.userGroupsDTOResponses![index]
//                                 .groupName ??
//                                 'ds',
...
//                               context,
//                               MaterialPageRoute(
//                                 builder: (context) => GetAllFilePage(
//                                   groupId: getAllGroupmodel
//                                       ?.userGroupsDTOResponses![index].groupID,
//                                 ),
//                               ),
//                             );
...
//                                       child: Text('مغادرة الغروب'),
//                                       onPressed: () {
//                                         GetallgroupCubit.get(context)
//                                             .leaveGroup(
//                                           groupID: getAllGroupmodel
//                                               ?.userGroupsDTOResponses?[index]
//                                               .groupID,
//                                         );
//                                       },
//                                     ),
